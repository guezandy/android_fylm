...
import com.fylm.aws.models.DownloadModel;
import com.fylm.aws.models.TransferModel;
import com.fylm.aws.models.UploadModel;
...
public class NetworkService extends IntentService {
        ...
        if (intent != null && intent.getAction() != null) {
            if (intent.getAction().equals(Intent.ACTION_GET_CONTENT) &&
                ...
                download(intent.getStringArrayExtra(S3_KEYS_EXTRA));
                    ...
                    intent.getData() != null) {
                Log.i("Inside Network services", "Lat: " + intent.getStringExtra("lat"));
                upload(intent.getData(), intent.getDoubleExtra("lat", 0.0), intent.getDoubleExtra("long", 0.0));
    ...
    private void upload(Uri uri, Double lat, Double log) {

        UploadModel model = new UploadModel(this, uri, mTransferManager, lat, log);
